  ...
  xmlhttp=GetXmlHttpObject();
   ...
   if (xmlhttp==null)
   {
    ...
    return;
     ...
     url=url+"?course="+str+"&studentId="+document.getElementById("sid").value;
...
<H4> <td> <b><u><LABLE > <h4>ADD SECTION </h4></LABLE> </u></B></td> </H4>
</table>
<div style=" ">
<%
...
<tr><td><label>  StudentID:</label></td><td><input type="text" ID="sid" name="sid"></input></td></tr></table>
<!-- code ends here -->
...
<button type="button" onClick="checkAll()">Register</button>
</div>
<!-- code ends here -->
